( function() {
	...
	function flatten( arr, owner ) {
		...
		for( ; i < l; i++ ) {
			...
			} else if( el instanceof self.NodeList || el instanceof NodeList || el instanceof HTMLCollection || el instanceof Array ) {
	...
	NL = NodeList.prototype = {
		...
		concat: function concat() {
			...
			for( ; i < l; i++ ) {
				...
				} else if( arg instanceof self.NodeList || arg instanceof NodeList || arg instanceof HTMLCollection || arg instanceof Array ) {
					flatten( arg );
				} else {
	...
	if( self.Symbol && Symbol.iterator ) NL[ Symbol.iterator ] = NL.values = ArrayProto[ Symbol.iterator ];
