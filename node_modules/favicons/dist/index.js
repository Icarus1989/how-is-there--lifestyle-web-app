...
import { sourceImages } from "./helpers.js";
import { getPlatform } from "./platforms/index.js";
import { dummyLog, prettyLog } from "./logger.js";
export const config = {
    defaults: defaultOptions,
};
async function createFavicons(source, options) {
    options = defaultsDeep(options, defaultOptions);
    const log = options.logging ? prettyLog : dummyLog;
...
export function favicons(source, options = {}, next = undefined) {
    if (next) {
